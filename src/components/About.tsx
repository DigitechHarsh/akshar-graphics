      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
        ...
        <div>
          ...
          <p className="text-slate-600 text-lg mb-8 leading-relaxed">
            ...
            precision in Surat for over 20 years.
          </p>
          ...
          <div className="grid grid-cols-3 gap-12 pt-12 border-t border-slate-100">
            <div><p className="text-4xl font-black text-primary mb-1">20+</p><p className="text-xs text-slate-400 uppercase tracking-widest font-bold">Years</p></div>
